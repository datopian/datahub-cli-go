...
type Context struct {
	Topic         *cobra.Command         `json:"topic"`
	Command       *cobra.Command         `json:"command"`
	App           string                 `json:"app"`
...
func BuildContext(command *cobra.Command, args []string) (*Context, error) {
	var err error
	if command == nil {
		return nil, errHelp
	}
...
func parseVarArgs(command *cobra.Command, args []string) (result []string, flags map[string]interface{}, err error) {
...
func parseArgs(command *cobra.Command, args []string) (result map[string]string, flags map[string]interface{}, err error) {
